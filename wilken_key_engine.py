...
FOLIO_WILKEN_TRANSLATIONS.update({
        ...
        "wilken_key_analysis": {
            "plant_1": {
                ...
                "phase_breakdown": {
                    ...
                    "strike": "Slots 9-11 - dy terminal: Daybreak dose delivery; féach-ráig dawn completion"
                },
        ...
        "wilken_key_analysis": {
            "plant_1": {
                ...
                "phase_breakdown": {
                    ...
                    "fringe": "Slots 5-8 - e vowel: Barely-warm water infusion; heat above 60°C degrades the valerenic acid",
    ...
    "f70v": {
        ...
        "wilken_key_analysis": {
            ...
            "phase_breakdown": {
                ...
                "strike": "Slots 9-11 - dy terminal: The Ram strikes forward into the new season; the féach-ráig March outbreak = planting, harvesting spring roots, beginning new treatments"
            },
    ...
    "f73v": {
        ...
        "wilken_key_analysis": {
            ...
            "phase_breakdown": {
                ...
                "strike": "Slots 9-11 - dy terminal: The arrow itself IS the féach-ráig sudden outbreak; the target nymph at 8 o'clock receives the strike; winter solstice dosing = the darkest moment of the year"
            },
            ...
            4. THE RELEASED ARROW (Strike / féach-ráig):
    ...
    "f76r": {
        ...
        "wilken_key_analysis": {
            ...
            specific mineral treatment begins. Temperature: 38-40°C.
            ...
            Temperature: 40-42°C (maximum tolerance).
    ...
    "f116v": {
        ...
        "wilken_key_analysis": {
            ...
            "phase_breakdown": {
                ...
                "strike": "Slots 9-11 - dy/o terminal: The final strike is the ENTIRE MANUSCRIPT delivered to the reader; the colophon IS the completed féach-ráig"
            },
